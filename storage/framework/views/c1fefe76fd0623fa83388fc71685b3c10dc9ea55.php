...
<div class="container jumbotron   border border-success">
    ...
    <table class="table">
      ...
      <tbody>
               <tr> 
                   <td><div class="" ><img src="../public/upload/<?php echo e($slide->slide); ?>" alt="Product Image" style="width: 300px;"></div></td>
...
<?php echo $__env->make('pages.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\Web_nhomF_1\Web_nhomF_1\resources\views/banner/index.blade.php ENDPATH**/ ?>