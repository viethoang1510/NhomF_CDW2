...
<div class="container">
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="slide1" style="font-weight: bold">Slide Hình:</label>
...
<?php echo $__env->make('pages.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Web_nhomF_1\resources\views/banner/create.blade.php ENDPATH**/ ?>