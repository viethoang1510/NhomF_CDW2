...
<div class="container jumbotron   border border-success">
    ...
    <table class="table">
           ...
           <tr>
            ...
            <td> 
              <a class="button btn btn-success" href="<?php echo e(route('banner.edit',$item->id)); ?>"><i class="fas fa-tools"></i>  Sửa</a>
...
<?php echo $__env->make('pages.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Web_nhomF_3\resources\views/banner/index.blade.php ENDPATH**/ ?>